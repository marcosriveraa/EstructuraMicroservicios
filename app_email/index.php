...
// Procesar datos
    ...
    $datos = [ 'id' => $mensaje_id, 'destinatario' => $destinatario, 'asunto' => $asunto, 'cuerpo' => $cuerpo, 'fecha' => $timestamp];
...
// logs
    ...
    $cuerpo = "Mensaje enviado a la cola de correos";
...
<body>
    <form action="" id="form" method="POST">
        <h2>Formulario de Envío de Email</h2>
        <input type="text" name="destinatario"  placeholder="Destinatario" required>
        <input type="text" name="asunto" placeholder="Asunto" required>
        <textarea name="cuerpo" placeholder="Cuerpo" required></textarea>
